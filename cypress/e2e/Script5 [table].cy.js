...
describe('table',()=>{
    ...
    it('first table',()=>{
        ...
        cy.get('body > div:nth-child(4) > div:nth-child(2) > div:nth-child(2) > div:nth-child(2) > div:nth-child(3) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(4) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(3) > div:nth-child(2) > table:nth-child(2) > tbody:nth-child(1) > tr:nth-child(2) > td:nth-child(3)')
        ...
        cy.get('table[id=productTable] tbody> tr td:nth-child(3)').each(($e,index,$list)=> {
            ...
            if(text.includes("$10.99"))
            {
                cy.get("table[id='productTable'] tbody> tr td:nth-child(2)").eq(index).then(function(pname)
                {
                    ...
                    expect(productname).to.equal("Smartphone")
                })
            }
